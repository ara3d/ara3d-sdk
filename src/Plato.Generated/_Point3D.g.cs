...
[MethodImpl(AggressiveInlining)] public Point3D Lerp(Point3D b, Number t){
            var _var53 = t;
            return this.ZipComponents(b, (a1, b1)  => a1.Lerp(b1, _var53));
        }
...
[MethodImpl(AggressiveInlining)] public IReadOnlyList<Point3D> Sample(Point3D b, Integer n){
            ...
            {
                var _var54 = this;
                return n.LinearSpace.Map((i)  => _var54.Lerp(_var55, i));
            }
        }
...
[MethodImpl(AggressiveInlining)] public Point3D Deform<_T0>(_T0 t) where _T0 : ITransform3D{
            var _var56 = t;
            return this.Deform((v)  => v.Vector3.Transform(_var56.Matrix));
        }

[MethodImpl(AggressiveInlining)] public Point3D Scale(Vector3 v){
            var _var57 = v;
            return this.Deform((p)  => p.Vector3.Multiply(_var57));
        }
...
[MethodImpl(AggressiveInlining)] public Point3D Rotate(Quaternion q){
            var _var58 = q;
            return this.Deform((v)  => _var58.Transform(v));
        }
...
[MethodImpl(AggressiveInlining)] public Point3D Translate(Vector3 v){
            var _var59 = v;
            return this.Deform((p)  => p.Add(_var59));
        }
