...
[MethodImpl(AggressiveInlining)]  public static implicit operator Ray3D(Line3D x) => x.Ray3D;
        ...
        /* Geometry_15.Reverse(x: Line3D): Line3D [Library]; */
        /* IInterval_17.Reverse(x: IInterval<$T>): IInterval<$T> [Library]; */
...
// AMBIGUOUS FUNCTIONS 2
        /* Geometry_15.Center(x: Line3D): Point3D [Library]; */
        /* IInterval_17.Center(x: IInterval<$T>): $T [Library]; */
