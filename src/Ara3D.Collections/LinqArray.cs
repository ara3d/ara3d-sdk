...
namespace Ara3D.Collections
{
    ...
    public static class LinqArray
    {
        ...
        /// </summary>
        public static T First<T>(this IReadOnlyList<T> self, T @default = default)
        ...
        /// </summary>
        public static IReadOnlyList<T> SelectGroupsByIndex<T>(this IReadOnlyList<T> self, int groupSize, IReadOnlyList<int> indices)
        ...
        public static IReadOnlyList2D<V> CartesianProduct<T, U, V>(this IReadOnlyList<T> self, IReadOnlyList<U> other, Func<U, T, V> func)
