...
public static Vector8 MinValue { [MethodImpl(AggressiveInlining)] get  => Vector8.CreateFromComponent(Plato.Number.MinValue); } 
public static Vector8 MaxValue { [MethodImpl(AggressiveInlining)] get  => Vector8.CreateFromComponent(Plato.Number.MaxValue); } 
