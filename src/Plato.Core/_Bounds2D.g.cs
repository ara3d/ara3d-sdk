...
public IReadOnlyList<Point2D> Corners { [MethodImpl(AggressiveInlining)] get  => Intrinsics.MakeArray((this.Min.X, this.Min.Y), (this.Max.X, this.Min.Y), (this.Min.X, this.Max.Y), (this.Max.X, this.Max.Y), (this.Min.X, this.Min.Y), (this.Max.X, this.Min.Y), (this.Min.X, this.Max.Y), (this.Max.X, this.Max.Y)); } 
