...
public static Point2D MinValue { [MethodImpl(AggressiveInlining)] get  => Point2D.CreateFromComponent(Plato.Number.MinValue); } 
public static Point2D MaxValue { [MethodImpl(AggressiveInlining)] get  => Point2D.CreateFromComponent(Plato.Number.MaxValue); } 
...
[MethodImpl(AggressiveInlining)] public Point2D RoundToZero(Integer digits){
            var _var39 = digits;
            return this.MapComponents((x)  => x.RoundToZero(_var39));
        }

[MethodImpl(AggressiveInlining)] public Point2D ScaleB(Integer n){
            var _var40 = n;
            return this.MapComponents((x)  => x.ScaleB(_var40));
        }
...
[MethodImpl(AggressiveInlining)] public Point2D Lerp(Point2D b, Number t){
            var _var41 = t;
            return this.ZipComponents(b, (a1, b1)  => a1.Lerp(b1, _var41));
        }
...
[MethodImpl(AggressiveInlining)] public System.Collections.Generic.IReadOnlyList<Point2D> Sample(Point2D b, Integer n){
            ...
            {
                var _var42 = this;
                return n.LinearSpace.Map((i)  => _var42.Lerp(_var43, i));
            }
        }
