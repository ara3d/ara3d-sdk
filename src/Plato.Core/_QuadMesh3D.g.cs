...
[MethodImpl(AggressiveInlining)] public QuadMesh3D Deform<_T0>(_T0 t) where _T0 : ITransform3D{
            var _var94 = t;
            return this.Deform((v)  => v.Vector3.Transform(_var94.Matrix));
        }

[MethodImpl(AggressiveInlining)] public QuadMesh3D Scale(Vector3 v){
            var _var95 = v;
            return this.Deform((p)  => p.Vector3.Multiply(_var95));
        }
...
[MethodImpl(AggressiveInlining)] public QuadMesh3D Rotate(Quaternion q){
            var _var96 = q;
            return this.Deform((v)  => _var96.Transform(v));
        }
...
[MethodImpl(AggressiveInlining)] public QuadMesh3D Translate(Vector3 v){
            var _var97 = v;
            return this.Deform((p)  => p.Add(_var97));
        }
