...
public static class GeometryCreationBacklog
{
    ...
    [
        ...
        new("IFCARBITRARYOPENPROFILEDEF", GeometryCreationSupport.Partial, "Open profile curves for ribbon extrusion."),
        ...
        new("IFCSURFACEOFLINEAREXTRUSION", GeometryCreationSupport.Partial, "Open-curve ribbon extrusion."),
